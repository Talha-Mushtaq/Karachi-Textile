...
class dbconn
{
 ...
 function Login()
 {
   ...
   function ProductInsert($p_title , $p_cat ,$p_price, $newImage , $p_detail)
   {
             $ret = false;      
       try
       {

      $sql = "INSERT INTO product(PRODUCTTITLE, PRODUCTCATEGORY, PRODUCTPRICE , PRODUCTIMAGE, PRODUCTDETAIL) VALUES ('$p_title' , '$p_cat','$p_price', '$newImage' , '$p_detail')";
      $insert =  $this->dbcon->prepare($sql);
      
       $insert->bindparam(':PRODUCTTITLE',$p_title);
       $insert->bindparam(':PRODUCTCATEGORY',$p_cat);
       $insert->bindparam(':PRODUCTPRICE',$p_price);
