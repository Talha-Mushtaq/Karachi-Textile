...
<head>
  ...
  <title>Karachi Dyeing & Exporters</title>
	...
	<div class="container">
		<div class="row">
						...
						<svg width="135px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" font-size="40" font-family="AustinBold, Austin" font-weight="bold">
						        <g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
						            <text id="AVIATO">
										<tspan x="108.94" y="325">KD</tspan><br>
										<tspan x="108.94" y="325">Dyeing & Exporters</tspan>
						            </text>
						        </g>
						    </g>
						</svg>
			...
			<ul class="top-menu text-right list-inline">
	          <li class="cart-nav">
	            <a href="cart.php"><i class="tf-ion-android-cart"></i>Cart</a>
	    ...
	    <div class="container">
	      ...
	      <div id="navbar" class="navbar-collapse collapse">
	        <ul class="nav navbar-nav">
	          ...
	          <!-- Products -->
	          <!-- <li class="dropdown ">
	            <a href="shop-sidebar.html">Products</a>
			  </li> -->
				...
				<!-- awards 
				<li class="dropdown ">
					<a href="Awards&Certification.php">Awards & Certification</a>
				</li><!-- / awards -->
				
				<li class="dropdown ">
					<a href="shop-sidebar.php">Products</a>
				</li>
				...
				<!--plants-->
				<li class="dropdown ">
					<a href="Machinery-units.php">Industry Units</a>
				</li>
				<!--plants-->
				
				<!--news and events -->
				<li class="dropdown ">
					<a href="Production.php">Daily Production</a>
				</li><!-- /events -->
