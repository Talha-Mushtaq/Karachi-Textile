...
<section class="main-slider">
	<div id="home_slider_wrapper" class="rev_slider_wrapper fullscreen-container" >
		<div id="home_slider" class="rev_slider fullscreenbanner tiny_bullet_slider" data-version="5.4.1">
			<ul>	<!-- SLIDE  -->
				<li data-index="rs-73" 
				data-thumb="images/industry/knit.jpg"
				...
				data-description="">
					<!-- MAIN IMAGE -->
					<img src="images/industry/knit.jpg" 
					...
					<!-- <div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 400; color: #000; letter-spacing: 10px;font-family:Roboto Condensed;">PRODUCTS </div> -->
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #000; letter-spacing: -2px;font-family:Playfair Display;">We have 22 brand new knitting machines all equipped with lycra with all other accessories.</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-74" 
					data-transition="fade" 
					...
					data-easeout="default" 
					data-masterspeed="300"  
					data-thumb="images/industry/dyeing-hero.jpg"  
					data-rotate="0"  
					data-saveperformance="off"  
					data-title="Slide">
					<!-- MAIN IMAGE -->
					<img src="images/industry/dyeing-hero.jpg" alt=""  
						data-bgposition="cover"
						data-bgfit="cover"
						data-bgrepeat="no-repeat"
						data-bgparallax="on" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #000; letter-spacing: -2px;font-family:Playfair Display;">State-of-the-art dye house for cotton & blends, with various, capacity machines producing lot-to-lot shade continuity. Latest fabric shrinkage control inblended and stretch fabrics. 
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-75" 
					...
					data-easeout="default" 
					data-masterspeed="300" 
					data-thumb="images/industry/13.jpg"
					data-rotate="0"  
					data-saveperformance="off"  
					data-title="Slide" 
					data-param1="" 
					...
					data-description="">
					<!-- MAIN IMAGE -->
					<img src="images/industry/13.jpg"
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #000; letter-spacing: -2px;font-family:Playfair Display;">Our stitching machines modular in structure, equipped with the latest garment handling system </div>
 ...
 <!-- This is our design  from home modeling -->

 <!-- special -->
 <!-- <div class="special">
	<div class="services-info">
		<h2 style="text-align: center;margin-top: 80px;color: purple;font-weight: bold;font-size: 300%;font-family: 'Ubuntu Condensed', sans-serif;">Our Designs</h2>
	</div>
	<div class="special-grids" style="margin-top: 20px;margin-bottom: 50px;">
		<div class="col-md-6 w3l-special-grid">
			<div class="col-md-6 w3ls-special-img">
				<img src="images/products/-1099781961-1188991164.jpg"/>
			</div>
		...
		<div class="container">
			...
			<div class="our-top">
				<div class="col-md-7 col-sm-7 col-xs-12 our-left heading">
					...
					<p style="text-align: justify;">Curabitur volutpat turpis et metus molestie tincidunt. Morbi blandit dapibus efficitur. Fusce a efficitur massa. Donec a fermentum libero.Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Cras condimentum euismod mollis. </p>
				</div>
				<div class="col-md-5 col-sm-5 col-xs-12 our-right">
					<a href="#"><img src="images/products/01.jpg" alt="trousers-img" height="370"/></a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="our-top">
				<div class="col-md-5 col-sm-7 col-xs-12 o-left">					
					<a href="#"><img src="images/products/05.jpg" alt="socks-img" height="370" width="370"/></a>
				</div>
				<div class="col-md-2"></div>
				<div class="col-md-5 col-sm-5 col-xs-12 o-right  heading">
					<h3>Socks Fabrics</h3>
					<p style="text-align: justify;">Curabitur volutpat turpis et metus molestie tincidunt. Morbi blandit dapibus efficitur. Fusce a efficitur massa. Donec a fermentum libero.</p>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="our-top">
				...
				<div class="col-md-5 col-sm-5 col-xs-12 our-right">
					<a href="#"><img src="images/products/04.jpg" alt=""  height="370" width="350"/></a>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
...
<!--    start of extra text   comment by talha
...
<section class="products section bg-gray">
	<div class="container">
       ...
       <!-- end of extra text  comment by talha       -->
				...
				<div id="instafeed">
					...
					<div id="Carousel" class="carousel slide">
						...
						<div class="row">
							...
							<div class="col-md-2"><img src="images/polo2.jpg" alt="clients_logo" height="150" width="250"/></div>
							<div class="col-md-1"></div>
							<div class="col-md-2"><img src="images/flint.png" alt="clients_logo" height="200" width="250"/></div>
							<div class="col-md-1"></div>
							<div class="col-md-2"><img src="images/tomford_18.jpg" alt="clients_logo" height="200" width="250"/></div>
							<div class="col-md-1"></div>
							<div class="col-md-2"><img src="images/acne.png" alt="clients_logo" height="200" width="250"/></div>
							<div class="col-md-1"></div>
